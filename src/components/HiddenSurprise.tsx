        ...
        {!isRevealed ? <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-pink-100/80 to-purple-100/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-xl border border-white/40">
              ...
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                ...
                <p>🌟 This world is lucky to have a soul like you in it.  
You shine in ways you don't even realize, touching lives with your gentle heart and beautiful spirit.  


Every time you doubt yourself, remember this moment.  
Remember that someone believes in you so deeply that they built you a little corner of the internet filled with love.  
...
I know the path you’ve chosen isn’t easy.  
The long nights, the pressure, the self-doubt — it all gets heavy sometimes.  


But **you are capable of achieving everything you dream of**.  
You have the strength, the brain, and the heart to make it real.
...
And your dreams? They're already waiting for you.  
**Go grab them, Akka. 🌟**
...
Because your thambi believes in you. Always. 💖
